...
def parse_args():
    ...
    parser.add("--audio_infer_path", default="demo/2_scott_0_1_1_test.wav", type=str, help="path to the audio for inference")
    ...
    parser.add("--inference", action="store_true", help="whether to inference")
