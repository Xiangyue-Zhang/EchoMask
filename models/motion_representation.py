...
class VQVAEConvZero_VAE(nn.Module):
    def __init__(self, args):
        super(VQVAEConvZero_VAE, self).__init__()
        self.encoder = VQEncoderV5(args)
        self.quantizer = Quantizer_VAE(args.vae_codebook_size, args.vae_length, args.vae_quantizer_lambda)
        self.decoder = VQDecoderV5(args)
